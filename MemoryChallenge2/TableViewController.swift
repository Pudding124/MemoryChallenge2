...
class TableViewController: UITableViewController {
    ...
    let name : [String] = ["咖波", "可靠的狗狗", "正面的小雞"]
    let imageName : [String] = ["1.jpg", "13.jpg", "25.jpg"]
    let imageNumber : [Int] = [1, 2, 3]
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "chooseImage" {
            ...
            viewController.userImageNumber = self.imageNumber[(tableView.indexPathForSelectedRow?.row)!]
        }
    }
